...
def main():
    ...
    print("""
  ######################################
  # MXs Development Environment Setup #
  ######################################

  This script will create your MXs dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your MXs project folder:
    [Arma 3 installation directory]\\{} => MXs project folder
    P:\\{}                              => MXs project folder
